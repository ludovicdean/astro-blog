...
![Page d'accueil de PowerToys](/devendevenir/images/powertoys-homepage.png)
&nbsp;
...
![Paramétrage des extensions de l'explorateur de fichiers Windows](/devendevenir/images/powertoys-explorateur-fichiers.png)
